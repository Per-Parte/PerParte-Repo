...
describe("composição dupla — separação × raios × envelopes", () => {
  it("o cenário da auditoria (Sino a 7 cm) ganha ar sozinho", () => {
    ...
    const c = ajustarComposicaoDupla(CORPO, SINO, [], {
      comPlaca: false,
  ...
  it("dois difusores no teto do slider raseiam até caber", () => {
    ...
    const c = ajustarComposicaoDupla(CORPO, grande, [], {
      comPlaca: false,
  ...
  it("curva S para dentro respeita o ar entre as colunas", () => {
    ...
    const c = ajustarComposicaoDupla(corpoDebrucado, DIFUSORES[0], [], {
      comPlaca: false,
      separacaoPedidaMm: 160,
      separacaoTetoMm: 160,
    });
  ...
  it("determinística: mesma entrada, mesma saída (contrato preview = STL)", () => {
    const a = ajustarComposicaoDupla(CORPO, SINO, [], {
      comPlaca: false,
      separacaoPedidaMm: 100,
      separacaoTetoMm: 150,
    });
    const b = ajustarComposicaoDupla(CORPO, SINO, [], {
      comPlaca: false,
      separacaoPedidaMm: 100,
      separacaoTetoMm: 150,
    });
